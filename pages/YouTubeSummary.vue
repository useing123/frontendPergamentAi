<template>
    <div class="min-h-screen flex flex-col items-center justify-center bg-white text-gray-900">
      ...
      <main class="flex flex-1 flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div 
          class="w-full max-w-xl mb-8 border-2 border-dashed rounded-lg p-6 flex flex-col items-center justify-center"
        >
  ...
  export default {
    ...
    methods: {
      ...
      async summaryYouTube() {
        ...
        try {
          const response = await axios.post('https://pergamentai.onrender.com/process-youtube/', { youtube_url: this.youtubeUrl });
